...
class Gen_compressed(threading.Thread):
  ...
  def gen_core(self):
    ...
    self.do_compile(target_filename, filenames, "")
  ...
  def gen_blocks(self):
    ...
    self.do_compile(target_filename, filenames, remove)
  ...
  def do_compile(self, target_filename, filenames, remove):
    cmd = [
      'java',
